...
class ExcelTools():
    ...
    def read_excel(excel_path, sheet_name, skip_first=True):
        """
            ...
            返回值：
                [
                    [1, "查询所有病例报告", "/haimo/sass/case/sassListCase/10/1","{}", '{"token": user_login}', 200, 1],
                    [行2],
                    [行3]..
                ]
        """
...
if __name__ == "__main__":
    a = ExcelTools.read_excel('D:\\haimoAPITest\\data\\海默接口信息.xlsx', '病例列表')
    print(a)

    # [
    #     [1.0, '查询所有病例报告', '/haimo/sass/case/sassListCase/10/1', '{}', '{"token": user_login}', 200.0, 1.0],
    #     [2.0, '查看所有医院', '/haimo/sass/hospital/release/listEffectiveHospital', '', '{"token": user_login}', 200.0, 1.0],
    #     [3.0, '搜索病例', '/haimo/sass/case/sassListCase/10/1', '[{"patientName":""}, {"patientName":"","phone":"13888889999"}, {"patientName":"","phone":"","gender":1}]', '{"token": user_login}', 200.0, 1.0]
    # ]
